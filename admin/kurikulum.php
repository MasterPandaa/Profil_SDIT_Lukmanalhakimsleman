...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data
    $query = "UPDATE kurikulum SET judul = ?, deskripsi = ?, konten = ?, updated_at = NOW() WHERE id = 1";
...
<head>
    ...
    <title>Kurikulum - Admin Panel</title>
        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
            <div class="position-sticky pt-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="kurikulum.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Edit Kurikulum</h5>
                </div>
                <div class="card-body">
