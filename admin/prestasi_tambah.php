...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($message)) {
        $query = "INSERT INTO prestasi (judul, deskripsi, tanggal, tingkat, foto) VALUES (?, ?, ?, ?, ?)";
        $stmt = mysqli_prepare($conn, $query);
        mysqli_stmt_bind_param($stmt, "sssss", $judul, $deskripsi, $tanggal, $tingkat, $foto);
...
<head>
    ...
    <title>Tambah Prestasi - Admin Panel</title>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="tingkat" name="tingkat" required>
                                        ...
                                        <option value="Sekolah" <?php echo (isset($tingkat) && $tingkat == 'Sekolah') ? 'selected' : ''; ?>>Sekolah</option>
                                        <option value="Kecamatan" <?php echo (isset($tingkat) && $tingkat == 'Kecamatan') ? 'selected' : ''; ?>>Kecamatan</option>
                                        <option value="Kabupaten" <?php echo (isset($tingkat) && $tingkat == 'Kabupaten') ? 'selected' : ''; ?>>Kabupaten</option>
                                        <option value="Provinsi" <?php echo (isset($tingkat) && $tingkat == 'Provinsi') ? 'selected' : ''; ?>>Provinsi</option>
                                        <option value="Nasional" <?php echo (isset($tingkat) && $tingkat == 'Nasional') ? 'selected' : ''; ?>>Nasional</option>
                                        <option value="Internasional" <?php echo (isset($tingkat) && $tingkat == 'Internasional') ? 'selected' : ''; ?>>Internasional</option>
                                    </select>
                                </div>
                                <div class="mb-3">
